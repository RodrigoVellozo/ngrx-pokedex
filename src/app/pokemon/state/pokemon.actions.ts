...
export const loadPokemon = createAction(
  PokemonActionsEnum.LOAD_POKEMON,
  props<{ pokemonId: string | number, pokemonQuery: GetAllQuery }>()
);

export const loadPokemonSuccess = createAction(
  PokemonActionsEnum.LOAD_POKEMON_SUCCESS,
  props<{ pokeResponse: any[] }>()
);

export const loadPokemonError = createAction(
  PokemonActionsEnum.LOAD_POKEMON_ERROR,
  props<{ error: HttpErrorResponse }>()
);

export const loadPokemons = createAction(
  PokemonActionsEnum.LOAD_POKEMONS,
);

export const loadPokemonsSuccess = createAction(
  PokemonActionsEnum.LOAD_POKEMONS_SUCCESS,
  props<{ pokemonsResponse: any }>()
);

export const loadPokemonsError = createAction(
  PokemonActionsEnum.LOAD_POKEMONS_ERROR,
  props<{ error: HttpErrorResponse }>()
);

export const loadPokemonsTypes = createAction(
  PokemonActionsEnum.LOAD_POKEMONS_TYPES
);

export const loadPokemonsTypesSuccess = createAction(
  PokemonActionsEnum.LOAD_POKEMONS_TYPES_SUCCESS,
  props<{ pokemonsTypesResponse: any[] }>()
);

export const loadPokemonsTypesError = createAction(
  PokemonActionsEnum.LOAD_POKEMONS_TYPES_ERROR,
  props<{ error: HttpErrorResponse }>()
);
